...
def summarize():
    ...
    if request.method == "POST":
        ...
        # Get the textarea content from the request object.
        textarea_content = request.form["inputtext_"]
    return render_template("output.html", data = {"summary": summary, "textarea_content": textarea_content})
